...
set Library     "hls"
set IPName      "measure_con"
set Version     "1.0"
set DisplayName "Measure_con"
set Revision    "2112544145"
...
set sdx_kernel_name "measure_con"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Github/HDMI_Measure/HDMI_delay_withFPGA/hls/hdmi_measure_tarou/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {measure_con_AXILiteS_s_axi
measure_con
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 result_count_V R 0x0 "Data signal of result_count_V" {{0 32 result_count_V R 0 "Bit 31 to 0 Data signal of result_count_V"}}} {0x14 result_count_V_ctrl R 0x0 "Control signal of result_count_V" {{0 1 result_count_V_ap_vld R 0 "Control signal result_count_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 measure_start_V W 0x0 "Data signal of measure_start_V" {{0 1 measure_start_V W 0 "Bit 0 to 0 Data signal of measure_start_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 result_finished_V R 0x0 "Data signal of result_finished_V" {{0 1 result_finished_V R 0 "Bit 0 to 0 Data signal of result_finished_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 result_finished_V_ctrl R 0x0 "Control signal of result_finished_V" {{0 1 result_finished_V_ap_vld R 0 "Control signal result_finished_V_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 measure_reset_V W 0x0 "Data signal of measure_reset_V" {{0 1 measure_reset_V W 0 "Bit 0 to 0 Data signal of measure_reset_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 7.5 machine 64 combinational 0 latency 1 II x}
